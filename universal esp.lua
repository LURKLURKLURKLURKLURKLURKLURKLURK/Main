...
local esp = {
    ...
    limitdistance    = false,
    renderdistance   = 50,
    outlines         = {enabled = true, color = c3rgb(0,0,0)},
    fontsize         = 13,
    font             = 2,
    distance_mode    = 'studs',
    text             = {enabled = true, color = c3rgb(255,255,255)},
    misc_layout      = {
        ['arrows']    = {transparency = 1, enabled = true, size = 10, color = c3rgb(255,255,255),radius = 500},
        ['box']       = {inner = true, inner_trans = 0.5, inner_color = c3rgb(0,0,0), enabled = true, color = c3rgb(255,255,255)},
        ['health']    = {enabled = true, lower = c3rgb(255,0,0),higher = c3rgb(255,255,255),position = 'left'},
